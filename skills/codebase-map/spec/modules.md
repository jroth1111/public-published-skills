...
- `scripts/indexer.py`: repo discovery, AST extraction, CodeQL integration, and IR assembly.
- `scripts/packer.py`: digest/expand/find/deps views and token budgeting.
